    ...
    <div className="space-y-10 pb-20 max-w-5xl mx-auto">
      ...
      <div className="flex items-center gap-4 border-b border-zinc-800 pb-8">
         ...
         <div>
            ...
            <p className="text-zinc-500 text-[10px] font-black uppercase tracking-[0.3em] pl-1">Documentation & Endpoint Guide</p>
         </div>
      </div>

      {/* API Key Box - Simple */}
      <div className="bg-zinc-900 rounded-[32px] p-8 border border-zinc-800 space-y-4">
         <div className="flex items-center gap-3">
            <ShieldCheck className="w-5 h-5 text-emerald-500" />
            <h3 className="text-xs font-black text-zinc-400 uppercase tracking-widest">Authentication Key</h3>
         </div>
         <div className="flex items-center gap-4 bg-zinc-950 p-4 rounded-2xl border border-zinc-800">
            <code className="text-emerald-500 font-mono text-sm break-all flex-1">
               {profile?.apikey || '••••••••••••••••••••••••••••••••'}
            </code>
            <button 
      ...
      <div className="bg-zinc-900 rounded-[32px] overflow-hidden border border-zinc-800 shadow-2xl">
         <div className="px-8 py-6 bg-zinc-800/50 border-b border-zinc-800 flex items-center justify-between">
            <h4 className="text-xs font-black text-white uppercase tracking-widest flex items-center gap-2">
               <Globe className="w-4 h-4 text-indigo-500" /> Endpoints
            </h4>
            <span className="text-[10px] text-zinc-500 font-bold">Base URL: {host}</span>
         </div>
            ...
            <div className="p-8 space-y-6">
               <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  ...
                  <div className="flex gap-2">
                    <span className="px-3 py-1 bg-indigo-500/10 text-indigo-500 text-[8px] font-black rounded-full border border-indigo-500/10 uppercase">Streamtape</span>
                    <span className="px-3 py-1 bg-orange-500/10 text-orange-500 text-[8px] font-black rounded-full border border-orange-500/10 uppercase">Doodstream</span>
                  </div>
               </div>

               <p className="text-zinc-500 text-xs font-medium max-w-2xl leading-relaxed">Panggil seluruh koleksi film dari semua server dalam satu kali permintaan HTTP. Data diurutkan berdasarkan waktu unggah terbaru secara global.</p>
               ...
               <div className="space-y-4">
                  <h6 className="text-[10px] font-black text-zinc-600 uppercase tracking-widest">Response Body</h6>
      ...
      <div className="bg-zinc-900 rounded-[32px] p-10 border border-zinc-800 shadow-2xl">
         <div className="flex items-center gap-3 border-b border-zinc-800 pb-6 mb-8">
            ...
            <h3 className="text-xs font-black text-zinc-400 uppercase tracking-widest uppercase italic">Query Parameters</h3>
         </div>
         <table className="w-full text-left">
            <thead>
               <tr className="text-[10px] font-black text-zinc-600 uppercase tracking-[0.2em] border-b border-zinc-800/60 pb-4">
                  <th className="pb-4 font-black">Parameter</th>
                  <th className="pb-4 font-black">Type</th>
                  <th className="pb-4 font-black">Required</th>
            ...
            <tbody className="divide-y divide-zinc-800">
               <tr className="group">
                  ...
                  <td className="py-6 text-xs text-zinc-500">API Key unik Anda dari halaman profil.</td>
               </tr>
            </tbody>
         </table>
      </div>
